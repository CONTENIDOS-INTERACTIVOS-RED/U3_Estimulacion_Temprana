        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde los primeros años de vida, la estimulación temprana juega un papel fundamental en el desarrollo integral de los niños, potenciando sus habilidades cognitivas, motoras, lingüísticas y socioemocionales. En este contexto, diseñar e implementar estrategias efectivas en el aula es clave para generar aprendizajes significativos y acompañar adecuadamente a los niños en esta etapa crucial de su crecimiento. 
              
              p #[b ¡Prepárese para afrontar los retos del trabajo con la primera infancia con confianza y eficacia!]
